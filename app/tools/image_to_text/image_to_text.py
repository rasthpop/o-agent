...
from app.prompts.i2t import TEXT_PASS_PROMPT, ENV_ARCHITECTURE_PROMPT, ENV_CELESTIAL_PROMPT, ENV_INFRASTRUCTURE_PROMPT
...
def image_to_geoguessr_features(image_base64, media_type="image/jpeg"):
    ...
    celestial_features = _run_claude_vision(
        image_base64,
        media_type,
